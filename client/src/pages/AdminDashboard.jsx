  ...
  <div className={styles.modalOverlay} onClick={() => setShowOrderDetails(false)}>
    <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
      ...
      <div className={styles.orderDetails}>
        ...
        {/* Shipping Address Section - Only show if address exists */}
        {selectedOrder.address && (
          <div className={styles.detailSection}>
            <h3>Shipping Address</h3>
            <p><strong>Name:</strong> {selectedOrder.address.name || "N/A"}</p>
            <p><strong>Phone:</strong> {selectedOrder.address.phone || "N/A"}</p>
            <p><strong>Street:</strong> {selectedOrder.address.street || "N/A"}</p>
            <p><strong>City:</strong> {selectedOrder.address.city || "N/A"}</p>
            <p><strong>State:</strong> {selectedOrder.address.state || "N/A"}</p>
            <p><strong>Postal Code:</strong> {selectedOrder.address.postalCode || "N/A"}</p>
            <p><strong>Country:</strong> {selectedOrder.address.country || "N/A"}</p>
          </div>
        )}
        ...
        <div className={styles.detailSection}>
          ...
          {selectedOrder.videos?.map((video, index) => (
            <div key={index} className={styles.orderItem}>
              <p><strong>Video:</strong> {video.title || `Video ${index + 1}`}</p>
              <p><strong>Price:</strong> {formatCurrency(video.price)}</p>
            </div>
          ))}
          <div className={styles.orderTotal}><h3>Total: {formatCurrency(selectedOrder.totalAmount)}</h3></div>
